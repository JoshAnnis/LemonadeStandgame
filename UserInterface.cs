...
namespace Lemonade_Stand_game
{
    public class UserInterface
    {
        ...
        public void title()
        {
            ...
            Console.WriteLine("In order to sell lemonade, you will need to keep enough supplies on had to make sure you'll have enough for all the customers that might stop by ");


            Console.WriteLine(" But make sure you dont buy to much, because things happen and you'll have to off set your cost to buy ingredients");


            Console.WriteLine("\nYou have $20 to your name. Try not to spend it all at once\n");
