...
namespace Lemonade_Stand_game
{
    public class UserInterface
    {
        ...
        public void title()
        {
            ...
            Console.WriteLine("In order to sell lemonade, you will need to keep enough surplies on had to make sure you'll have enough for all the customers that might stop by ");
